window.onload = function() {
    ...
    function update() {
        ...
        lh.file = 'http://ievappwpdcpvm01.nyumc.org/?file=' + subj.ID + '_lh.pial';
        // lh.file = 'http://x.babymri.org/?lh.smoothwm';
        lh.color = [2, 0, 1];
        lh.opacity = 0.3;
                
        rh.file = 'http://ievappwpdcpvm01.nyumc.org/?file=' + subj.ID + '_rh.pial';
        // rh.file = 'http://x.babymri.org/?rh.smoothwm';
        rh.color = [0, 1, 1];
        rh.opacity = 0.2;

        p.file = 'http://ievappwpdcpvm01.nyumc.org/?file=' + subj.ID + '_T1.vtk';
